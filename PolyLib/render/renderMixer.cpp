...
void renderMixer(Mixer &mixer) {
    ...
    mixer.oscALevel = max(mixer.oscALevelSteiner.nextSample, mixer.oscALevelLadder.nextSample);
    ...
    mixer.oscBLevel = max(mixer.oscBLevelSteiner.nextSample, mixer.oscBLevelLadder.nextSample);
    ...
    mixer.subLevel = max(mixer.subLevelSteiner.nextSample, mixer.subLevelLadder.nextSample);
    ...
    mixer.noiseLevel = max(mixer.noiseLevelSteiner.nextSample, mixer.noiseLevelLadder.nextSample);
