...
void initPotiMapping() { // TODO fill mapping
    ...
    potiFunctionPointerA3[0] = std::bind(&Analog::setValue, &(allLayers[0]->oscA.aBitcrusher), std::placeholders::_1);
    potiFunctionPointerA1[0] = std::bind(&Analog::setValue, &(allLayers[0]->oscA.aDetune), std::placeholders::_1);
    potiFunctionPointerA0[0] = std::bind(&Analog::setValue, &(allLayers[0]->oscA.aFM), std::placeholders::_1);
